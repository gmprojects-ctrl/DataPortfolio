...
int main(){
   ...
   for(int i=0; i < ncols; i++){
    ...
    current_value = c*(coeff[indxmod(l_i,l_j-1,N_t,N_z)].Q12+coeff[indxmod(l_i-1,l_j,N_t,N_z)].Q12);
    ...
    //b T_{i-1}{j}
    m = indxfold(l_i-1 ,l_j ,N_t,N_z);
    current_value = 4*a*((coeff[indxmod(l_i-1,l_j,N_t,N_z)].Q11+coeff[indxmod(l_i,l_j,N_t,N_z)].Q11)/2);
    past_value = getv(&bmat,fold_row,m);
    setv(&bmat,fold_row,m,current_value+past_value);  
    //setv(&bmat,i,m,2);
    ...
    //d T_{i}{j-1}
    m = indxfold(l_i ,l_j-1,N_t,N_z);
    current_value = 4*b*((coeff[indxmod(l_i,l_j-1,N_t,N_z)].Q22+coeff[indxmod(l_i,l_j,N_t,N_z)].Q22)/2);
    past_value = getv(&bmat,fold_row,m);
    ...
    current_value = 4*b*((coeff[indxmod(l_i,l_j+11,N_t,N_z)].Q22+coeff[indxmod(l_i,l_j,N_t,N_z)].Q22)/2);
    past_value = getv(&bmat,fold_row,m);
    setv(&bmat,fold_row,m, current_value + past_value);  
    //setv(&bmat,i,m,6);
  ...
  do{
    ...
    for(int i=0; i < ncols; i++){
      ...
      part_a = -4*a*((coeff[indxmod(l_i+1,l_j,N_t,N_z)].Q11+coeff[indxmod(l_i,l_j,N_t,N_z)].Q11)/2 +  (coeff[indxmod(l_i-1,l_j,N_t,N_z)].Q11+coeff[indxmod(l_i,l_j,N_t,N_z)].Q22)/2  );
      part_b = -4*b*((coeff[indxmod(l_i,l_j+1,N_t,N_z)].Q22+coeff[indxmod(l_i,l_j,N_t,N_z)].Q22)/2 +  (coeff[indxmod(l_i,l_j-1,N_t,N_z)].Q22+coeff[indxmod(l_i,l_j,N_t,N_z)].Q22)/2  );
